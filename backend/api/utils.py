...
def create_shopping_list_pdf(shopping_cart):
    ...
    pdfmetrics.registerFont(
        TTFont('Times-New-Roman', 'data/fonts/Times-New-Roman.ttf', 'UTF-8')
    )
    page.setFont('Times-New-Roman.ttf', size=20)
    page.drawString(x=130, y=750, text='Список ингредиентов для рецептов')
    page.setFont('Times-New-Roman.ttf', size=14)
    height = 700
    ...
    page.setFont('Times-New-Roman.ttf', size=10)
